...
- 👍💪 Finished 42 Curriculum projects at Codam:<br>
  > Libft = in C, make your own library containing functions that mimic libc library functions,
    and additional utility functions (useful for later in the curriculum)<br>

  > ft_printf = in C, recreate your own version of the original printf function<br>

  > get_next_line = in C, write functions to deal with reading from a file and memory management<br>

  > push_swap = in C, make a program that can sort a list of random numbers, using only 2 stacks and algorithm
    restrictions<br>
...
- 👯 I’m looking to collaborate on coding projects in C or Python<br>
